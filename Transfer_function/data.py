...
while t!=1:
    ...
    try :
        ...
        if real_Speed > target_Speed + diff :
            dutyrate = float(dutyrate - 0.05)
        elif real_Speed < target_Speed - diff :
            dutyrate = float(dutyrate + 0.05)
        else :
        ...
        #print('Speed : %f km/h, Target Speed : %f km/h, DutyRate : %d' %(real_Speed, target_Speed, dutyrate))
